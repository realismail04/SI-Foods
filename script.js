...
if(window.innerWidth < 1000) {
    ...
    dropdownItems.forEach(dropdownItem => {
        dropdownItem.addEventListener('mouseover', () => {
            ...
            document.querySelector('.navbar-wrapper').style.background = 'linear-gradient(to right, #b96f00, #FF9800, #b96f00)'
            document.querySelector('.navbar-wrapper').style.borderBottom = '0.1rem solid white';
